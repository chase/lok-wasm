...
struct DESKTOP_DLLPUBLIC WasmDocumentExtension : public _LibreOfficeKitDocument
{
    ...
    _LibreOfficeKitDocument* loadFromExpanded(LibreOfficeKit* pThis, const std::vector<desktop::ExpandedPart>& parts, const char* pFilterOptions = nullptr);

};

struct DESKTOP_DLLPUBLIC WasmOfficeExtension : public _LibreOfficeKit
{
    _LibreOfficeKitDocument* documentExpandedLoad(std::vector<desktop::ExpandedPart>& parts, const char* pFilteroptions = NULL);
};
