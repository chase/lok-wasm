...
struct theXGraphicStorageHandlerType : public rtl::StaticWithInit< ::css::uno::Type *, theXGraphicStorageHandlerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.document.XGraphicStorageHandler" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.document.XGraphicStorageHandler::loadGraphic" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.document.XGraphicStorageHandler::loadGraphicAtPage" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.document.XGraphicStorageHandler::loadGraphicFromOutputStream" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.document.XGraphicStorageHandler::saveGraphic" );
        typelib_typedescriptionreference_new( &pMembers[3],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName3.pData );
        ::rtl::OUString sMethodName4( "com.sun.star.document.XGraphicStorageHandler::saveGraphicByName" );
        typelib_typedescriptionreference_new( &pMembers[4],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName4.pData );
        ::rtl::OUString sMethodName5( "com.sun.star.document.XGraphicStorageHandler::createInputStream" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::document::XGraphicStorageHandler const *) {
    const ::css::uno::Type &rRet = *detail::theXGraphicStorageHandlerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.graphic.XGraphic" );
                ::rtl::OUString sMethodName0( "com.sun.star.document.XGraphicStorageHandler::loadGraphic" );
            ...
            }
            {
                ...
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "nPage" );
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType1( "com.sun.star.graphic.XGraphic" );
                ::rtl::OUString sMethodName1( "com.sun.star.document.XGraphicStorageHandler::loadGraphicAtPage" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
            ...
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "xOutputStream" );
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType2( "com.sun.star.graphic.XGraphic" );
                ::rtl::OUString sMethodName2( "com.sun.star.document.XGraphicStorageHandler::loadGraphicFromOutputStream" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName2.pData,
            ...
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "xGraphic" );
                ::rtl::OUString sParamType0( "com.sun.star.graphic.XGraphic" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType5( "com.sun.star.io.XInputStream" );
                ::rtl::OUString sMethodName5( "com.sun.star.document.XGraphicStorageHandler::createInputStream" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    8, sal_False,
                    sMethodName5.pData,
